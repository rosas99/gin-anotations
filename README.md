...
[![Build Status](https://gin/workflows/Run%20Tests/badge.svg?branch=master)](https://gin/actions?query=branch%3Amaster)
[![codecov](https://codecov.io/gh/gin-gonic/gin/branch/master/graph/badge.svg)](https://codecov.io/gh/gin-gonic/gin)
[![Go Report Card](https://goreportcard.com/badge/gin)](https://goreportcard.com/report/gin)
[![Go Reference](https://pkg.go.dev/badge/gin?status.svg)](https://pkg.go.dev/gin?tab=doc)
[![Sourcegraph](https://sourcegraph.com/gin/-/badge.svg)](https://sourcegraph.com/gin?badge)
[![Open Source Helpers](https://www.codetriage.com/gin-gonic/gin/badges/users.svg)](https://www.codetriage.com/gin-gonic/gin)
[![Release](https://img.shields.io/github/release/gin-gonic/gin.svg?style=flat-square)](https://gin/releases)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/gin)](https://www.tickgit.com/browse?repo=gin)
...
See the [API documentation on go.dev](https://pkg.go.dev/gin).
...
Here are some awesome projects that are using the [Gin](https://gin) web framework.
